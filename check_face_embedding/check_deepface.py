...
import numpy as np
from human.deepface import DeepFaceReID, DEEPFACE_MODEL_NAMES
...
EMBEDDING_MODEL_NAMES = DEEPFACE_MODEL_NAMES
# [
...
def extract_feature(img_path):
    ...
    feature = DeepFaceReID.represent(str(img_path), model_name=EMBEDDING_MODEL_NAME)
    # {
    #   "embedding": [...]
...
def main():
    ...
    for embedding_model_name in EMBEDDING_MODEL_NAMES:
        ...
        scores = []
        score_file = Path(f"{SCORE_DIR}/deepface-{EMBEDDING_MODEL_NAME}-scores.csv")
