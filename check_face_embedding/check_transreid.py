...
from human.transreid import TransReID, TRANSREID_MODEL_NAMES
...
EMBEDDING_MODEL_NAMES = TRANSREID_MODEL_NAMES
...
def extract_feature(img_path: Path):
    ...
    feature: np.ndarray = TransReID.represent(str(img_path), model_name=EMBEDDING_MODEL_NAME)
...
def main():
    ...
    for embedding_model_name in EMBEDDING_MODEL_NAMES:
        ...
        scores = []
        score_file = Path(f"{SCORE_DIR}/transreid-{EMBEDDING_MODEL_NAME}-scores.csv")
        ...
        try:
            ...
            print(f"ERROR[{embedding_model_name}]: {e}")
