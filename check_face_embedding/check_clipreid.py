...
from human.clipreid import ClipReID, CLIPREID_MODEL_NAMES
...
EMBEDDING_MODEL_NAMES = CLIPREID_MODEL_NAMES
...
def extract_feature(img_path: Path):
    ...
    feature: np.ndarray = ClipReID.represent(str(img_path), model_name=EMBEDDING_MODEL_NAME)
...
def main():
    ...
    for embedding_model_name in EMBEDDING_MODEL_NAMES:
        ...
        scores = []
        score_file = Path(f"{SCORE_DIR}/clipreid-{EMBEDDING_MODEL_NAME}-scores.csv")
