...
_lr_productions = [
  ...
  ('optattributes -> [ attributelist ]','optattributes',3,'p_optattributes','dotimport.py',152),
  ('optattributes -> empty','optattributes',1,'p_optattributes','dotimport.py',153),
  ('attributelist -> attribute , attributelist','attributelist',3,'p_attributelist','dotimport.py',158),
  ('attributelist -> attribute','attributelist',1,'p_attributelist','dotimport.py',159),
  ('attributelist -> empty','attributelist',1,'p_attributelist','dotimport.py',160),
  ('attribute -> ID = STRING','attribute',3,'p_attribute','dotimport.py',164),
  ('empty -> <empty>','empty',0,'p_empty','dotimport.py',171),
]
