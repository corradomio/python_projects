...
y_pred_qual = classification_quality(df_pred)
...
class FlowerClient(fl.client.NumPyClient):
    ...
    def __init__(self, df: DataFrame, cid):
        self.cid = cid
        ...
        # [trick] initial fit otherwise 'coef_' and 'intercept_' are missing
