...
from pandasx import partitions_split
...
#
X_parts, y_parts = partitions_split(X_train, y_train, partitions=[1, 2, 3])
...
class FlowerClient(fl.client.NumPyClient):
    ...
    def __init__(self, model: LogisticRegression,
                 ...
                 cid: int):
        self.cid = cid
        print(f'[{self.cid}] __init__ ... {X_train.shape}, {X_test.shape}')
