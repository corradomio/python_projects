...
class EfficientDet(nn.Module):
    def __init__(self, num_anchors=9, num_classes=20, compound_coef=0, use_cuda=False):
        ...
        self.anchors = Anchors(use_cuda)
        self.regressBoxes = BBoxTransform(use_cuda)
        self.clipBoxes = ClipBoxes()
        self.focalLoss = FocalLoss(use_cuda)
