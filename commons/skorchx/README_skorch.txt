...
fit(X, y)
    ...
    **fit_params : dict
    ...
    Sembra che accetti anche un oggetto avente attributi "X" e "y"

-----------------------------------------------------------------------------

Ci sono una serie di metodi che devono essere "adattati":

    to_tensor       converte in torch.Tensor
    to_numpy        converte in numpy.ndarray
    to_type         equivalente ad uno dei precedenti.
