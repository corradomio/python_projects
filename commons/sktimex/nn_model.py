...
# ---------------------------------------------------------------------------
# SimpleRNNForecasterOld
# ---------------------------------------------------------------------------

# class SimpleRNNForecasterOld(BaseForecaster):
# 
#     _tags = {
#         # to list all valid tags with description, use sktime.registry.all_tags
#         #   all_tags(estimator_types="forecaster", as_dataframe=True)
...
# 
#         # convert 'criterion' and 'optimizer' in string
#         params['criterion'] = stdlib.qualified_name(params['criterion'])
#         params['optimizer'] = stdlib.qualified_name(params['optimizer'])
# 
#         return params
#     # end
# 
