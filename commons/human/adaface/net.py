...
def build_model(architecture='ir_50'):
    if architecture == 'ir_101':
        return IR_101(input_size=(112,112))
    elif architecture == 'ir_50':
        return IR_50(input_size=(112,112))
    elif architecture == 'ir_se_50':
        return IR_SE_50(input_size=(112,112))
    elif architecture == 'ir_34':
        return IR_34(input_size=(112,112))
    elif architecture == 'ir_18':
        return IR_18(input_size=(112,112))
    else:
        raise ValueError('not a correct model name', architecture)
