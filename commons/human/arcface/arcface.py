...
from .helpers import face_alignment

__all__ = ["YakhyoArcFace"]
...
class YakhyoArcFace:
    ...
    def __init__(self, model_path: str) -> None:
        ...
        self.logger = logging.getLogger("YakhyoArcFace")

        self.logger.info(f"Initializing ArcFace model from {self.model_path}")
        ...
        try:
            ...
            self.logger.error(f"Failed to load face encoder model from '{self.model_path}'", exc_info=True)
