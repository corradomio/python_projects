...
def resolve(
    ...
    # NO: it is necessary to apply 'resolve' to remove keys starting
    # with '#'
...
class JSONConfiguration(JSONConfig):
    ...
    def __init__(self, config_of_file: str | dict, smarker: str="{", emarker: str="}", marker: str="$"):
        super().__init__(config_of_file, smarker, emarker, marker)
# end
