...
from .gminmax import period_diff, interpolate_bounds, select_bounds, fit_function, select_seasonal_values
from .gminmax import poly1, poly3, power1
...
class GroupsDetrendTransformer(GroupsBaseEncoder):
