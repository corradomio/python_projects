...
DT_CONVERTERS: dict[tuple[type, type], Callable] = {
    ...
    (datetime64, datetime64): dt_convert,
    ...
    (Timestamp, Timestamp): dt_convert,
...
def to_period(dt: DT_TYPES, freq):
    # Period(value)
