...
import numpy as np
from numpy import ndarray, ones, zeros, dot, mean, all, abs
...
class LinearPredictTransform:
    ...
    def _xat(self, i):
        return self.Xh[i] if i < 0 else self.Xp[i] if self.Xp is not None else self.X0[0]
    def _yat(self, i):
