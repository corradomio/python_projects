...
def train_test_split(*arrys, train_size:Union[int,float]=0, test_size:Union[int,float]=0):
    """
    Split the arrays in 'arrys' in train/validate/test if val_size is not 0 else in train/test.
    The parameter 'train_size' is alternative to 'test_size'
    The parameters 'train_size', 'test_size' and 'val_size' can be specified as integer values or
