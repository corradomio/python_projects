...
class Chomp1d(nn.Module, TorchLayerMixin):
...
class TemporalBlock(nn.Module, TorchLayerMixin):
...
class TemporalConvNet(nn.Module, TorchLayerMixin):
    def __init__(self, input_size, channel_size, kernel_size=2, dropout=0.2):
        super(TemporalConvNet, self).__init__()
        layers = []
        num_levels = len(channel_size)
