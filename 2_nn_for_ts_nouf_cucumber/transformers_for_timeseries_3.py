# -*- coding: utf-8 -*-
"""Transformers-for-timeseries.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1AiK2Ydp2VwsiWU5px1WAg9sikBF4FrwF
"""
...
def split_dataset(data, TRAIN_SPLIT=0.7, VAL_SPLIT=0.5, save_path=None):
    ...
    train_data, test_data = train_test_split(data_in_seq, train_size=TRAIN_SPLIT, shuffle=True, random_state=123)
...
def data_to_dataset(train_data, test_data, batch_size=32, target_features=list(range(1))):
    '''
...
train_dataset, test_dataset = data_to_dataset(train_data, test_data)
...
def positional_encoding(D, position=128, dim=3, device=device):
...
for (x, y) in test_dataset:
    S = x.shape[-2]
    mask = create_look_ahead_mask(S)
    y_pred, _ = transformer(x, mask=mask)
