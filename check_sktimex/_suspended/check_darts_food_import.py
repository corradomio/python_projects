...
def main():
    ...
    for g in dfdict:
        ...
        xscaler = pdx.MinMaxScaler(feature_range=(0, 1), columns=NUMERICAL)
        yscaler = pdx.MinMaxScaler(feature_range=(0, 1), columns=TARGET, clip=0)
        ...
        # PROBLEM: depends on DarTS version, we have ts.to_series() and ts.pd_series()
        y_predict_scaled = sktx.darts.to_series(predict)
