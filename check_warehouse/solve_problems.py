...
class LocationsServed(FunctionalProblem):
    ...
    def __init__(self, D: np.ndarray, dmin: float=0., wmax: int=100):
        self.D: np.ndarray = D
...
def solve_locations_served(data, dmin: float=0., wmax: int = -1):
    ...
    algorithm = NSGA2(
        ...
        sampling=BinaryRandomSampling2D_(D, wmax),
        crossover=TwoPointCrossover2D_(),
        mutation=BitflipMutation2D_(prob_var=0.1),
...
def main():
    ...
    solve_locations_served(data, 0.0, 10)
    pass
