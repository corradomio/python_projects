...
class YoloV1(nn.Module):
    ...
    def _create_fcs(self, split_size, num_boxes, num_classes):
        ...
        return nn.Sequential(nn.Flatten(), nn.Linear(1024 * S * S, 496), nn.Dropout(0.0), nn.LeakyReLU(0.1),
                             nn.Linear(496, S * S * (
                                         C + B * 5)))  # Original paper uses nn.Linear(1024 * S * S, 4096) not 496. Also the last layer will be reshaped to (S, S, 13) where C+B*5 = 13
...
files_dir = r'E:\Datasets\BBox\fruit-images-for-object-detection/train_zip/train'
test_dir = r'E:\Datasets\BBox\fruit-images-for-object-detection/test_zip/test'
