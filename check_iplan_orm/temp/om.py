...
class AttributeHierarchy(IPlanData):
    def __init__(self, ipom, id):
        ...
        self._type: Optional[Literal['area', 'skill']] = None
    ...
    def create(self, hierarchy_tree):
        ...
        hierarchy_type: Literal['area', 'skill'] = self._type
        self._id = self.ipom.create_attribute_hierarchy(self._name, hierarchy_tree, hierarchy_type)
        self._name = None
        self._type = None
        return self
# end
...
class AttributeHierarchies(IPlanObject):
    ...
    # def create_area_hierarchy(self, name: str, hierarchy_tree) -> int:
    #     return self.ipom.create_attribute_hierarchy(name, hierarchy_tree, 'area')
    #
    # def create_skill_hierarchy(self, name: str, hierarchy_tree) -> int:
...
class IDataModel(IPlanData):
    ...
    def delete(self):
        ...
        self._name = self.name
        self.ipom.delete_data_model(self.id)
        super().delete()
        return self
    ...
    def create(self,
        ...
        self._id = self.ipom.create_data_model(
            self._name,
            targets=targets,
            inputs=inputs,
            update=update)
...
class IDataModels(IPlanObject):
    def __init__(self, ipom):
        super().__init__(ipom)

    def data_model(self, id: Union[int, str]) -> IDataModel:
        data_model_id = self.ipom._convert_id(id, self.ipom.iDataModelMaster, ['description'], nullable=True)
        if data_model_id is None:
            return IDataModel(self.ipom, id)
        else:
            return IDataModel(self.ipom, data_model_id)
# end
...
class IDataMaster(IPlanData):
    ...
    def delete(self):
        assert is_instance(self._id, int)
        self._name = self.name
        self.ipom.delete_data_master(self._id)
        super().delete()
        return self
    # end
    ...
    def create(self,
        ...
        self._id = self.ipom.create_data_master(
            self._name,
...
class IDataMasters(IPlanObject):
    ...
    def data_master(self, id: Union[int, str]) -> IDataMaster:
        ...
        if data_master_id is None:
            return IDataMaster(self.ipom, id)
        else:
            return IDataMaster(self.ipom, data_master_id)
# end
...
class IPredictionPlans(IPlanObject):
    ...
    def plan(self, name: Union[str, datetime], data_master: Union[int, str]) -> "IPredictionPlan":
        ...
        return IPredictionPlan(self.ipom, name, data_master)
...
class IPlanObjectModel(IPlanObject):
    ...
    def data_models(self) -> IDataModels:
        return IDataModels(self)
    ...
    def data_masters(self) -> IDataMasters:
        return IDataMasters(self)
    ...
    def plans(self) -> IPredictionPlans:
        return IPredictionPlans(self)
    ...
    def data_values_master(self, id: Union[int, str]) -> IDataValuesMaster:
        ...
        return IDataValuesMaster(self, id)
