...
def plot_bounds(df_all, method):
    print("---")
    print("---", method)
    print("---")
    plot_dir = f'./plots/import_kg/bounds_outliers/{method}'
...
def main():
    ...
    Parallel(n_jobs=7)(delayed(plot_bounds)(df_all, method) for method in methods)
