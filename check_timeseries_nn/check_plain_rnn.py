...
def lstm1():
    ...
    tmodule = nn.Sequential(
        ...
        nnx.Probe("lstm"),
        # (*, 2*19) because return_sequence=False that is, it returns just the last element
...
def lstmn():
    ...
    tmodule = nn.Sequential(
        ...
        nnx.Probe("lstm"),
        # (*, 24, 19) because return_sequence=False that is, it returns just the last element
