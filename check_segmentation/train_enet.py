...
from torchx.nn.cvision.enet import EfficientNet
...
nnet = NeuralNetRegressor(
    ...
    scheduler__milestones=[20, 40, 60, 80, 100, 130, 160],
...
def main():
    ...
    with open('waterdrop2-enet.pkl', 'wb') as f:
        pickle.dump(nnet, f)
